# -*- coding: utf-8 -*-
"""
Created on Fri Jun 10 00:51:28 2022
...
# colors = ["red","dodgerblue","blueviolet","green"] ##ALL
# colors = ["blueviolet","red","dodgerblue","green"]  ##AA
# colors = ["dodgerblue","blueviolet","green","red"]  ##CA
...
# ######## cropping
file = r'D:\ep_cc\Rcodes\saved_folder\consensus004.png'
im = Image.open(file)
